...
for i in k:
    ...
    score = 1 - np.sum(np.abs(yhat - y_test))*1.0/len(X_test)
    knn_score.append(score)

i = k[knn_score.index(max(knn_score))]
knn = neighbors.KNeighborsRegressor(i)
knn.fit(X_train, y_train)
yhat = knn.predict(X_test)
accuracy = 1 - np.sum(np.abs(yhat - y_test))*1.0/len(X_test)
print accuracy, i
...
### ROC ###
logistic = linear_model.LogisticRegression(C=i)
y_test_score = logistic.fit(X,y).decision_function(X_test)
...
plt.plot(false_posi_rate, true_posi_rate, 'b',label='AUC = %0.5f'% rocauc,
        linewidth = 2)
plt.title('ROC of logisitic classification (C = '+str(i)+' )',size =20)
...
plt.figure()
plt.title('PR of logistic classification (C = '+str(i)+' )', size=20)
...
plt.rc('ytick', labelsize = 15)
plt.grid(True)
plt.savefig("logistic_pr.png")

print success, i
print confusion_matrix(y_test, yhat)
a =classification_report(y_test, yhat, digits=5)
print a
...
### ROC ###
lsvm = svm.SVC(kernel='linear', C = i)
y_test_score = lsvm.fit(X,y).decision_function(X_test)
false_posi_rate, true_posi_rate, thresholds = roc_curve(y_test, y_test_score)
rocauc = auc(false_posi_rate, true_posi_rate)
...
plt.plot(false_posi_rate, true_posi_rate, 'b',label='AUC = %0.5f'% rocauc,
        linewidth = 2)
plt.title('ROC of linear SVM (C = '+str(i)+' )',size =20)
plt.plot([0,1],[0,1],'r--',linewidth = 2)
plt.legend(loc='lower right')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
...
plt.rc('ytick', labelsize = 15)
plt.grid(True)
plt.savefig("lsvm_roc.png")

### PR ###
precision, recall, thesh = precision_recall_curve(y_test, y_test_score)

plt.figure()
plt.title('PR of linear SVM (C = '+str(i)+' )', size=20)
plt.plot(recall, precision, label='Precision-Recall curve',linewidth = 2)
plt.legend(loc='lower right')
plt.plot([0,1],[0,1],'r--')
plt.xlim([-0.1,1.1])
...
plt.plot(false_posi_rate, true_posi_rate, 'b',label='AUC = %0.5f'% rocauc,
        linewidth = 2)
plt.title('ROC of rbf SVM (C = '+str(i)+', gamma = '+str(j)+' )',size =20)
plt.plot([0,1],[0,1],'r--',linewidth = 2)
plt.legend(loc='lower right')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
...
plt.figure()
plt.title('PR of rbf SVM (C = '+str(i)+', gamma = '+str(j)+' )', size=20)
plt.plot(recall, precision, label='Precision-Recall curve',linewidth = 2)
plt.legend(loc='lower right')
plt.plot([0,1],[0,1],'r--')
plt.xlim([-0.1,1.1])
...
plt.plot(false_posi_rate, true_posi_rate, 'b',label='AUC = %0.5f'% rocauc,
        linewidth = 2)
plt.title('ROC of polynomial SVM (C = '+str(i)+', degree = '+str(j)+' )',size =20)
plt.plot([0,1],[0,1],'r--',linewidth = 2)
plt.legend(loc='lower right')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
...
plt.figure()
plt.title('PR of polynomial SVM (C = '+str(i)+', degree = '+str(j)+' )', size=20)
plt.plot(recall, precision, label='Precision-Recall curve',linewidth = 2)
plt.legend(loc='lower right')
plt.plot([0,1],[0,1],'r--')
plt.xlim([-0.1,1.1])
...
for i in c:
    temp_score = []
    for j in G:
        clf = svm.SVC(kernel='sigmoid', C = i, gamma = j)
        scores = cross_validation.cross_val_score(clf, X_train, y_train, cv=5)
        val = np.mean(scores)
        temp_score.append(val)
    ssvm_tscore.append(temp_score)
ssvm_score = np.array(ssvm_tscore)

s_max = np.amax(ssvm_score)
pos = np.where(ssvm_score == s_max)
i = c[pos[0][0]]
j = G[pos[1][0]]
ssvm = svm.SVC(kernel='sigmoid', C = i, gamma = j)
ssvm.fit(X,y)
yhat = ssvm.predict(X_test)
terror = np.sum(np.abs(yhat - y_test))*1.0/len(X_test)
success = 1 - terror

### ROC ###
ssvm = svm.SVC(kernel='sigmoid', C = i, gamma = j)
y_test_score = ssvm.fit(X,y).decision_function(X_test)
false_posi_rate, true_posi_rate, thresholds = roc_curve(y_test, y_test_score)
rocauc = auc(false_posi_rate, true_posi_rate)
...
plt.plot(false_posi_rate, true_posi_rate, 'b',label='AUC = %0.5f'% rocauc,
        linewidth = 2)
plt.title('ROC of sigmoid SVM (C = '+str(i)+', gamma = '+str(j)+' )',size =20)
plt.plot([0,1],[0,1],'r--',linewidth = 2)
plt.legend(loc='lower right')
plt.xlim([-0.1,1.1])
plt.ylim([-0.1,1.1])
...
plt.rc('ytick', labelsize = 15)
plt.grid(True)
plt.savefig("ssvm_roc.png")

### PR ###
precision, recall, thesh = precision_recall_curve(y_test, y_test_score)

plt.figure()
plt.title('PR of sigmoid SVM (C = '+str(i)+', gamma = '+str(j)+' )', size=20)
plt.plot(recall, precision, label='Precision-Recall curve',linewidth = 2)
plt.legend(loc='lower right')
plt.plot([0,1],[0,1],'r--')
plt.xlim([-0.1,1.1])
